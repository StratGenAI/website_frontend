          ...
          >
            ...
            >
              <Image
                ...
                priority
                unoptimized
                className="object-contain h-16 md:h-20 lg:h-24 w-auto max-w-[150px] md:max-w-[140px] lg:max-w-[160px]"
                style={{
            ...
            {navItems.map((item) => {
              ...
              return (
                <motion.a
                  ...
                  className="relative px-4 py-2 text-gray-700 hover:text-gray-900 transition-all font-heading font-medium text-base lg:text-lg rounded-lg hover:bg-gray-50 border border-transparent hover:border-gray-200 cursor-pointer"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  {item.label}
