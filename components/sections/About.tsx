...
export default function About() {
  ...
  const stats = [
    { number: '2+', label: 'Innovative Products', icon: Zap },
    { number: '100%', label: 'AI-Powered Solutions', icon: Target },
    { number: '2+', label: 'Industries Served', icon: Users },
  ]
    ...
    <section ref={sectionRef} id="about" className="py-32 bg-gradient-to-br from-white via-blue-50/30 to-pink-50/30 relative overflow-hidden">
      {lowPower ? (
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-pink-400 rounded-full blur-3xl" />
        </div>
      ) : (
      ...
      <div ref={ref} className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal direction="scale" delay={0.2}>
          <motion.div className="text-center mb-20" style={lowPower ? undefined : { y: textY }}>
            <motion.h2 
            ...
            >
              Building the future of AI-powered business solutions with intelligent automation
            </motion.p>
          </motion.div>
        </ScrollReveal>
            ...
            >
              ...
              <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-white/20">
                ...
                <div className="space-y-6 text-lg text-gray-700 leading-relaxed font-body">
                  ...
                  >
                    StratgenAI is a <strong className="text-blue-600 font-bold">cutting-edge AI software company</strong> that specializes in developing intelligent software solutions. We help businesses leverage the power of artificial intelligence to solve real-world problems, automate processes, and drive sustainable growth.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, x: -20 }}
                    animate={inView ? { opacity: 1, x: 0 } : {}}
                  ...
                  >
                    Our mission is to <strong className="text-pink-600 font-bold">democratize AI technology</strong> and make it accessible for businesses of all sizes. We combine deep technical expertise with strategic business insights to deliver solutions that not only work but truly transform how our clients operate and compete in their markets.
                  </motion.p>
                  <motion.p
                    initial={{ opacity: 0, x: -20 }}
                    animate={inView ? { opacity: 1, x: 0 } : {}}
