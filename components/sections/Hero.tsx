...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div ref={ref} className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-8 md:pt-12 lg:pt-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-display font-black mb-4 sm:mb-6 leading-tight"
          >
            <motion.span
